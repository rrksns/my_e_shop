...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		 $('#idChk').click(function(){
			...
			$.post("u_idChk.go","id="+id, function(msg){
				alert(msg);
			});
		}); 
	});	
...
<div class="universe">
  ...
  <section id="userInfo">
  	<form action="userJoin.go" name="frm" method="post" onsubmit="return chk()">
  	  <fieldset><legend class="hide">필수 정보 입력</legend>
  	  	<p class="small">기본 정보를 입력해 주세요.</p>
  	  	<div class="info_container">
  	  	  <div class="infoBox">
  	  	  	<span>아이디</span>
  	  	  	<input type="text" id="id" name="u_id" placeholder="아이디" required="required">&nbsp;
  	  	  	<input type="button" value="중복확인" id="idChk" >
  	  	  </div>
  	  	  <div class="infoBox">
  	  	  	<span>비밀번호</span>
  	  	  	<input type="password" id="pw" name="u_pw" placeholder="비밀번호" required ><span></span>
  	  	  </div>
  	  	  <div class="infoBox">
  	  	  	<span>비밀번호 확인</span>
  	  	...
  	  	<div class="info_container">
  	  	  <div class="infoBox">
  	  	  	<span>이름, 성별</span>
  	  	  	<div class="nameWrap">
  	  	  	  <input type="text" id="name" name="u_name" placeholder="이름" required>
  	  	  	  <input type="radio" id="gender_w" name="u_gender" checked="checked" value="f">
  	  	  ...
  	  	  <div class="birthdayBox">
  	  	  	...
  	  	  	<input type="text" name="u_birthdate" placeholder="2017-07-07" required="required">
  	  	  ...
  	  	  <div class="infoBox">
  	  	  	<span>이메일</span>
  	  	  	<input type="email" id="email" name="u_email" placeholder="이메일(e-mail)" required>
  	  	  </div>
  	  	</div>
  	  	<div class="info_container">
  	  	  <div class="infoBox">
  	  	  	<span>휴대전화 번호</span>
  	  	  	<input type="text" id="email" name="u_mobile" placeholder="휴대전화 번호(-없이)" required>
  	  	  </div>
  	  	</div>
