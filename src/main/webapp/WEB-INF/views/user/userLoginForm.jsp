...
<div class="universe">
  <section class="login">
  	...
  	<div class="userInfoWrap">
  	  <form action="userLogin.go" method="post">
  	  	<fieldset><legend class="hide">아이디, 비밀번호 로그인 정보 입력 폼</legend>
  	  	  <div class="inputWrap">
  	  	  	<label>아이디</label>
  	  	  	<input id="id" name="u_id" type="text" title="아이디 입력">
  	  	  	<label>비밀번호</label>
  	  	  	<input id="pw" name="u_pw"type="password" maxlength="32" autocomplete="off" title="비밀번호 입력">
  	  	  </div>
