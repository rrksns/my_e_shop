...
function chk() {				
	if(frm.select.value == "s"){ 
		location.href="s_joinForm.go"; 
		return false;			
	}else{location.href="u_joinForm.go";}
	return true;
}		
</script>
  	  	...
  	  	<form action="" name="frm" method="post" onsubmit="return chk()">
  	  	  <div class="selBtnWrap">
  	  	  	<div class="sel_btn fl_L">
  	  	  	  <input type="radio" id="basic" name="select" title="일반회원가입" value="u">
  	  	  	  <label for="basic">일반회원가입</label>
  	  	  	</div>
  	  	  	<div class="sel_btn fl_R">
  	  	  	  <input type="radio" id="shop" name="select" title="판매회원 가입" value="s">
