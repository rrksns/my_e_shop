	...
	<div class="universe">
		<header class="site-header">
			...
			<nav class="site-nav" role="navigation">
				...
				<ul>
					<li class="nav-list"><a class="cate-btn" href="#"
						role="button" title="카테고리 검색"><span class="cate-icon"></span>
							전체 카테고리 <span></span></a></li>
			...
			<div class="contents" role="main">
				<div class="near-shop">
					...
					<div class="main-frame">
						<div class="address">
							<p>
								현재 위치 : <span>span에 id값 준 후 출력</span>
							</p>
						</div>
