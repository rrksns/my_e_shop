  ...
  <div class="page-body">
  	<div class="contents" role="main">
  	  ...
  	  <div class="menu-line">
  	  	...
  	  	<div class="location">
  	  	  <p class="loc-txt"><span>${shop.sh_addr1}</span></p>
  	  	  <p class="loc-txt"><span>${shop.sh_addr2}</span></p>
  	  	  <div id="map"></div>
  	  	</div>
  	  </div>
  	   <div class="review">
...
<div class="universe">
  ...
  <div class="page-body">
  	<div class="contents" role="main">
  	  ...
  	  <div class="menu-line">
  	  	<div class="menu">
  	  	  ...
  	  	  <div class="top-menu">
  	  	  	<img class="menu-img" src="menuPic/upload/${menu.it_img1}" width="118" height="118" alt="대표메뉴1">
  	  	  	<img class="menu-img" src="menuPic/upload/${menu.it_img2}" width="118" height="118" alt="대표메뉴2">
  	  	  	<img class="menu-img" src="menuPic/upload/${menu.it_img3}" width="118" height="118" alt="대표메뉴3">
  	  	  	<div class="wrapper">
  	  	  	  <p>대표 메뉴</p>
  	  	  	  <img src="${path}/resources/img/icon/top3.png" width="50" height="50">
  	  	  	  <p>top3</p>
  	...
  	<aside class="support" role="complementary">
  	  ...
  	  <div class="photo">
  	  	<div class="main-photo">
  	  	  <img src="shopPic/upload/${shop.sh_img1}" width="255" height="180" alt="사진1">
  	  	</div>
  	  	<div class="sub-photo">
  	  	  <img src="shopPic/upload/${shop.sh_img2}" alt="사진2">
  	  	  <img src="shopPic/upload/${shop.sh_img3}" alt="사진3">
  	  	  <img src="shopPic/upload/${shop.sh_img4}" alt="사진4">
  	  	  <img src="shopPic/upload/${shop.sh_img5}" alt="사진5">
  	  	  <img src="shopPic/upload/${shop.sh_img6}" alt="사진6">
  	  	</div>
  	  </div>
  	  <div class="shop-info">
  	  	<h4 class="title">기본 정보</h4>
